...
struct ThreeLineElementTests {
    ...
    func Base34() {
        ...
        #expect(alpha5ID("A0000") == 100_000, "got \(alpha5ID("A0000"))")
        #expect(alpha5ID("H0000") == 170_000, "got \(alpha5ID("H0000"))")
        #expect(alpha5ID("J0000") == 180_000, "got \(alpha5ID("J0000"))")
        #expect(alpha5ID("N0000") == 220_000, "got \(alpha5ID("N0000"))")
        #expect(alpha5ID("P0000") == 230_000, "got \(alpha5ID("P0000"))")
        #expect(alpha5ID("Z0000") == 330_000, "got \(alpha5ID("Z0000"))")
        #expect(alpha5ID("Z9999") == 339_999, "got \(alpha5ID("Z9999"))")

        #expect(alpha5ID("J2931") == 182_931, "got \(alpha5ID("J2931"))")
        #expect(alpha5ID("W1928") == 301_928, "got \(alpha5ID("W1928"))")
        #expect(alpha5ID("E8493") == 148_493, "got \(alpha5ID("E8493"))")
        #expect(alpha5ID("P4018") == 234_018, "got \(alpha5ID("P4018"))")
        ...
        #expect(alpha5ID("a5678") == 105_678, "got \(alpha5ID("a5678"))")
