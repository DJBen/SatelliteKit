...
public struct EarthConstants: Sendable {
    ...
    private static let μₑ = 398_600.8 // gravitational constant (Km³/s²)
...
public class Propagator {
    ...
    public init(_ initialTLE: Elements) {
        tle = initialTLE
        perigee = (tle.a₀ * (1.0 - tle.e₀) - 1.0) * EarthConstants.Rₑ
        ...
        s = s / EarthConstants.Rₑ + 1.0

        /* ╭╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╮
         ┆ Computation of the first commons parameters.                                                     ┆
         ╰╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╯ */
        sini₀ = sin(tle.i₀)
        cosi₀ = cos(tle.i₀) //         cos(i₀)  ..  θ
        θ² = cosi₀ * cosi₀ //        cos²(i₀)  ..  θ²
        ...
        /* ╭╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╮
         ╰╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╯ */
        ξ = 1.0 / (tle.a₀ - s) //         1/(a₀ʺ-s) .. ξ
        η = tle.a₀ * tle.e₀ * ξ //           a₀ʺ×e×ξ .. η
        η² = η * η
        eeta = tle.e₀ * η //                      e×η

        coef = q₀_s * q₀_s * q₀_s * q₀_s *
            ξ * ξ * ξ * ξ //             (q₀-s)⁴ξ⁴
        let ψ² = abs(1.0 - η²) //              1-η² .. ψ²
        coef1 = coef / pow(ψ², 3.5)

        /* ╭╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╮
         ┆ C2 and C1 coefficients computation :                                                             ┆
         ╰╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╯ */
        let x3thm1 = 3.0 * θ² - 1.0 //      3×cos²(i₀) - 1
        c₂ = coef1 * tle.n₀ * //            (q₀-s)⁴ξ⁴η₀ʺ(1-η²) ** 7/2 *
            (tle.a₀ * (1.0 + 1.5 * η² + eeta * (4.0 + η²)) +
        ...
        /* ╭╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╮
         ...
         ╰╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╯ */
        c₄ = 2.0 * tle.n₀ * coef1 * tle.a₀ * β₀² * (η * (2.0 + 0.5 * η²) +
            tle.e₀ * (0.5 + 2.0 * η²) - 2.0 * EarthConstants.K₂ * ξ / (tle.a₀ * ψ²) *
            (-3.0 * x3thm1 * (1.0 - 2.0 * eeta + η² * (1.5 - 0.5 * eeta)) +
                0.75 * x1mth2 * (2.0 * η² - eeta * (1.0 + η²)) * cos(2.0 * tle.ω₀)))

        do {
            let pinv = 1.0 / (tle.a₀ * β₀²)
            let pinv² = pinv * pinv

            let temp1 = 3.0 * EarthConstants.K₂ * pinv² * tle.n₀
            let temp2 = temp1 * EarthConstants.K₂ * pinv²
            let temp3 = 1.25 * EarthConstants.K₄ * pinv² * pinv² * tle.n₀
            ...
            do {
                let θ⁴ = θ² * θ²
                M_dot = tle.n₀ + 0.5 * temp1 * β₀ * x3thm1 +
                    0.0625 * temp2 * β₀ * (13.0 - 78.0 * θ² + 137.0 * θ⁴)

                let x1m5θ² = 1.0 - 5.0 * θ² //              1-5θ²

                ω_dot = -0.5 * temp1 * x1m5θ² + 0.0625 * temp2 * (7.0 - 114.0 * θ² + 395.0 * θ⁴) +
                    temp3 * (3.0 - 36.0 * θ² + 49.0 * θ⁴)
            }

            let xhdot1 = -temp1 * cosi₀

            Ω_dot = xhdot1 + (0.5 * temp2 * (4.0 - 19.0 * θ²) +
                2.0 * temp3 * (3.0 - 7.0 * θ²)) * cosi₀
            xnodcf = 3.5 * β₀² * xhdot1 * c₁
        }
        t2cof = 1.5 * c₁
    ...
    public func getPVCoordinates(_ date: Date) throws -> PVCoordinates {
        try sxpPropagate(minsAfterEpoch: date.timeIntervalSince(Date(ds1950: tle.t₀)) / 60.0)
    ...
    private func computePVCoordinates() throws -> PVCoordinates {
        ...
        let xlcof = 0.125 * EarthConstants.J₃OVK₂ * sini₀ *
            (3.0 + 5.0 * cosi₀) / (1.0 + cosi₀)
        let aycof = 0.250 * EarthConstants.J₃OVK₂ * sini₀
        let aynl = temp * aycof
        let xlt = xl + temp * xlcof * axn
        let ayn = e * sin(ω) + aynl
        let elsq = axn * axn + ayn * ayn

        if elsq > 1.0 { throw SatKitError.SGP(sgpError: "4: semi-latus rectum < 0.0") }

        let capu = fmod2pi_π(xlt - Ω) // normalize an angle between 0 and 2π
        ...
        if e > (1 - 1e-6) { throw SatKitError.SGP(sgpError: "1: eccentricity too close to 1.0") }
        ...
        let xnodek = Ω + 1.5 * temp2 * cosi₀ * sin2u
        let xinck = i + 1.5 * temp2 * cosi₀ * sini₀ * cos2u
    ...
    func sxpPropagate(minsAfterEpoch _: Double) throws {
